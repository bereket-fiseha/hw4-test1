...
class LMDataset(Dataset):
    ...
    def __init__(
        ...
        subset_size = max(1, subset_size) if len(self.text_files) > 0 else 0
        ...
        for file in tqdm(self.text_files):
            ...
            # Load raw text stored in numpy format and convert to a string.
            transcript_path = os.path.join(self.text_dir, file)
